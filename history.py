...
# memory.save_context({"input": "你好，我叫吴昊"}, {"output": "你好啊，我叫小优"})
# memory.save_context(
#     {"input": "很高兴和你成为朋友！"}, {"output": "是的，让我们一起去冒险吧！"}
# )
# memory.load_memory_variables({})
...
# from langchain.memory import ConversationTokenBufferMemory  # type: ignore
...
# {input}"""
# # 第四个适合回答计算机问题
# computer_science_template = """ 你是一个成功的计算机科学专家。\
# 你有创造力、协作精神、\
# 前瞻性思维、自信、解决问题的能力、\
# 对理论和算法的理解以及出色的沟通技巧。\
# 你非常擅长回答编程问题。\
...
#         "名字": "计算机科学",
#         "描述": "擅长回答计算机科学问题",
#         "提示模板": computer_science_template,
#     },
# ]
...
# # print(default_chain.invoke("What is black body radiation?"))
...
# ```json
# {{{{
# "destination": 字符串使用的提示名字或者使用 "DEFAULT"
# "next_inputs": 字符串原始输入的改进版本
# }}}}
...
#     router_chain=router_chain,  # l路由链路
...
# from langchain.prompts import PromptTemplate  # type: ignore
# from langchain.base_language import BaseLanguageModel  # type: ignore
# from langchain.evaluation.qa import QAEvalChain # type: ignore #导入QA问题回答，评估链
# from typing import Any
# from tool import get_openai_key
...
# loader = PyPDFLoader("docs/pdf/2024年线上头发养护市场洞察报告.pdf")
# pages = loader.load()
# print(type(pages))
# print(len(pages))
# page = pages[1]
...
#             model_size, device="cpu", compute_type="int8", local_files_only=False
#         )
...
# huggingface_hub即使开了代理也未调通,尝试使用modelscope下载模型并转换音频